...
# Preserve the original 800--1000 second bounds at a 15-minute cadence.
# The same relative tolerance applies to every supported cadence.
CADENCE_SECONDS = NOMINAL_CADENCE_MINUTES * 60
CADENCE_TOLERANCE_SECONDS = CADENCE_SECONDS / 9.0
CONT_MIN_SEC = CADENCE_SECONDS - CADENCE_TOLERANCE_SECONDS
CONT_MAX_SEC = CADENCE_SECONDS + CADENCE_TOLERANCE_SECONDS
